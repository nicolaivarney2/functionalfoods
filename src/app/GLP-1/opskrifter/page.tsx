...
export default function GLP1RecipesPage() {
      ...
      <main className="min-h-screen bg-white">
        <div className="container py-24">
          <div className="text-center">
            ...
            <p className="text-gray-600">Indlæser GLP-1 opskrifter...</p>
          </div>
        </div>
      </main>
    )
        ...
        <div className="container relative">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Udforsk vores samling af GLP-1-optimeret opskrifter – alle designet til at booste din naturlige GLP-1 respons<br />
              og maksimere mæthed.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <div className="text-sm text-gray-500 flex items-center gap-2">
                ...
                Protein, fibre og sunde fedtstoffer • Maksimal mæthed
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <div className="relative flex-1 max-w-md w-full">
                ...
                <input
                  type="text"
                  placeholder="Søg i GLP-1 opskrifter..."
                  value={searchQuery}
          ...
          {filteredRecipes.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                {hasActiveFilters ? 'Ingen opskrifter fundet' : 'Ingen GLP-1 opskrifter endnu'}
              </h3>
              <p className="text-gray-600 mb-8">
                {hasActiveFilters
                  ? 'Prøv at justere dine filtre for at se flere opskrifter.'
                  : 'Vi arbejder på at tilføje flere GLP-1 opskrifter. Kom snart tilbage!'
                }
              </p>
              {hasActiveFilters && (
                <button
        ...
        <div className="container relative">
          <div className={`text-center transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white leading-tight">
              Vil du lære mere om GLP-1 kost?<br />
              <span className="text-blue-200">Læs teorien her</span>
            </h2>
            
            <p className="text-xl text-blue-100 mb-12 max-w-3xl mx-auto">
              Lær hvordan GLP-1 kost hjælper med vægttab gennem naturlig mæthed.
            </p>
