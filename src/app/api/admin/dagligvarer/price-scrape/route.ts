              ...
              if (updateError) {
                ...
                await supabase
                  ...
                  .insert({
                    ...
                    price: newPrice, // Current price (tilbudspris hvis der er tilbud)
                    original_price: newOriginalPrice, // Current original price
                    is_on_sale: updatedProduct.isOnSale, // Current sale status
