...
export default function MealPrepRecipesPage() {
  const mealPrepRecipes = [
    {
      id: '1',
      title: 'Meal Prep Kylling med Grøntsager',
      slug: 'meal-prep-kylling-med-groentsager',
      description: 'En nem og sund meal prep ret med kylling og masser af grøntsager.',
      ...
      imageAlt: 'Meal Prep Kylling med Grøntsager',
      preparationTime: 10,
      cookingTime: 20,
      totalTime: 30,
      servings: 4,
      ...
      updatedAt: new Date(),
      metaTitle: 'Meal Prep Kylling med Grøntsager Opskrift',
      metaDescription: 'Lækker og nem meal prep kylling med grøntsager.',
      keywords: ['meal prep', 'kylling', 'grøntsager', 'opskrift'],
      ...
      <section className="relative bg-gradient-to-br from-white via-purple-50/30 to-green-50/20 py-24 lg:py-32">
        ...
        <div className="container relative text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-8 text-gray-900 leading-tight">
            Lækre <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-green-600">meal prep opskrifter</span>
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Find inspiration til dine meal prep måltider med vores store udvalg af gratis opskrifter, der er nemme at lave og fulde af smag.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 mb-12">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                type="text"
                placeholder="Søg i meal prep opskrifter"
          ...
          {mealPrepRecipes.length === 0 && (
            <p className="text-center text-gray-600 text-lg mt-8">Ingen meal prep opskrifter fundet.</p>
          )}
        </div>
      </section>
    </main>
