...
export default function FamilieRecipesPage() {
  const familieRecipes = [
    {
      id: '1',
      title: 'Familiemad Kylling med Grøntsager',
      slug: 'familiemad-kylling-med-groentsager',
      description: 'En nem og sund familiemad ret med kylling og masser af grøntsager.',
      shortDescription: 'Perfekt til en hurtig hverdagsmiddag.',
      imageUrl: 'https://najaxycfjgultwdwffhv.supabase.co/storage/v1/object/public/recipe-images/familie-kylling-groentsager.webp',
      imageAlt: 'Familiemad Kylling med Grøntsager',
      preparationTime: 10,
      cookingTime: 20,
      totalTime: 30,
      servings: 4,
      ...
      updatedAt: new Date(),
      metaTitle: 'Familiemad Kylling med Grøntsager Opskrift',
      metaDescription: 'Lækker og nem familiemad kylling med grøntsager.',
      keywords: ['familiemad', 'kylling', 'grøntsager', 'opskrift'],
      ...
      <section className="relative bg-gradient-to-br from-white via-blue-50/30 to-green-50/20 py-24 lg:py-32">
        ...
        <div className="container relative text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-8 text-gray-900 leading-tight">
            Lækre <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600">familiemad opskrifter</span>
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Find inspiration til dine familiemad måltider med vores store udvalg af gratis opskrifter, der er nemme at lave og fulde af smag.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 mb-12">
            ...
            <button className="flex items-center gap-2 px-4 py-3 border-2 border-gray-200 rounded-xl text-gray-700 hover:border-blue-500 hover:text-blue-600 transition-all duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {familieRecipes.map(recipe => (
              <RecipeCard key={recipe.id} recipe={recipe} />
            ))}
          </div>

          {familieRecipes.length === 0 && (
            <p className="text-center text-gray-600 text-lg mt-8">Ingen familiemad opskrifter fundet.</p>
          )}
        </div>
      </section>
    </main>
