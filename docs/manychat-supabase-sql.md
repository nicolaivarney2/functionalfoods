# ManyChat / Messenger — SQL til Supabase

Kør **hele** blokken herunder én gang i **Supabase → SQL Editor → New query → Run**.

Brugerdata forbliver i FF; ManyChat får kun afledt kontekst via API.
...
Efter kørsel: se også [manychat-setup.md](manychat-setup.md) for env og ManyChat-felter.
